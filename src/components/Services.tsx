  ...
  const services = [
    {
      ...
      description:
        "We bring worn and dull hardwood back to a mirror shine. Specializing in historic heartpine, antique pine, and solid oak floors — our dustless sanding system and hand-mixed stains restore brilliance while protecting your home's air quality.",
    ...
    },
    {
      ...
      description:
        "Transform your staircase from tired carpet to stunning hardwood. We strip the old covering, sand each tread to bare wood, then apply a rich custom stain and durable poly coat — making your stairs the focal point of your home.",
    ...
    },
    {
      ...
      description:
        "From full subfloor teardown of water-damaged boards to precision fitting of new solid hardwood, we handle every step. We leave your floors as solid and smooth as the day the house was built.",
      image: "/hardwood-after.png",
      badge: "Expert Fitting",
      icon: Layers,
      features: [
    ...
    },
    {
      ...
      description:
        "We bring the same craftsmanship to commercial spaces — factories, offices, retail storefronts, and public buildings. Our work at local commercial facilities shows what durable, high-gloss hardwood looks like under professional hands.",
      image: "/commercial-factory-1.png",
      badge: "Professional Scale",
      icon: ShieldCheck,
      features: [
        "High-Traffic Hardwood Solutions",
        "Commercial-Grade Finish Coatings",
